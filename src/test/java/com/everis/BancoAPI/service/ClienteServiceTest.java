...
public class ClienteServiceTest {
    ...
    private ClienteModel cliente2(){
        ClienteModel c = new ClienteModel("Eric", "09520853804", "Rua paulista, 155",
                "11944556677");
        return c;
    }
    ...
    public void salvarDeveSalvarCliente(){
        ...
        Optional<ClienteModel> cliente = Optional.ofNullable(clienteService.salvar(c1));
    ...
    public void salvarClienteJaDeveExistir(){
        ...
        ClienteModel cliente = clienteService.salvar(c1);
        ClienteModel cliente2 = clienteService.salvar(c2);
    }
...
//    }
    ...
    public void listarClienteJaExiste(){
        ...
        List<ClienteModel> expected = clienteService.listar();
    ...
    public void DeletarClienteNaoExiste() {
        ClienteModel cliente = cliente();
        given(repository.findByCpf(cliente.getCpf())).willReturn(Optional.ofNullable(null));
