...
public class ContaServiceTest {
    ...
    @Autowired
    private OperacoesModel operacoesModel;
    ...
    public void salvarDeveSalvarConta(){
        ...
        ResponseEntity<?> expected = contaService.salvar(conta);

        AssertionsForClassTypes.assertThat(conta.getCodigo().equals(expected));
    }
    ...
    public void consultarContaDeveRetornarConta(){
        ...
        HttpEntity<?> expected = contaService.consultar(conta.getNumero());

        AssertionsForClassTypes.assertThat(conta.getNumero().equals(expected));
    ...
    public void listarContaJaExiste(){
        ...
        ResponseEntity<List<?>> expected = contaService.listar();
...
//    }
    ...
    public void extratoContaDeveRetornarExtrato(){
        ...
        ResponseEntity<List<?>> expected = contaService.extrato(conta.getNumero());
    ...
    public void extratoTodasAsContas(){
        ...
        ResponseEntity<List<?>> expected = contaService.exibirExtratos();
